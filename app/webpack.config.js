...
const ydocAttachPatch = path.resolve(__dirname, 'ydoc-attach-patch.js');
...
fs.copySync(ydocAttachPatch, path.resolve(buildDir, 'ydoc-attach-patch.js'));
...
const bootstrap =
  'import("./fast-colors-sort-patch.js");\n' +
  'import("./ydoc-attach-patch.js");\n' +
  'import("./index.js");';
