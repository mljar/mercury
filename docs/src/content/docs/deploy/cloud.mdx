...
Prefer the terminal? Run `mercury publish` to sign in, configure a website,
and choose files to upload. See [Publish from the terminal](/deploy/publish/)
for the guided CLI and repeat updates.
