...
vertical scrolling. A fixed-height chat always owns its scrollbar, even before its
content is tall enough to overflow, so multiple chats cannot compete for the page
scroll position.
