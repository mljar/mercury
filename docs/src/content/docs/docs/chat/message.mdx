...
<MercuryDemo
  iframeSrc="https://demo.ismvp.org/mercury/chat?no-navbar"
  notebookUrl="https://github.com/mljar/mercury/blob/v3/docs/notebooks/chat.ipynb"
/> 
...
## Message as a Generic Output Container ⭐
