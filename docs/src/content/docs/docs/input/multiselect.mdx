...
<Code code={`from mercury import MultiSelect`} lang="python" />
...
After clearing selections in the UI:

```text
[]
```

After selecting new values:
...
<MercuryDemo
iframeSrc="https://demo.ismvp.org/mercury/multiselect-basic?no-navbar"
notebookUrl="https://demo.ismvp.org/mercury/multiselect-basic"
/>
