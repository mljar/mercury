...
<div style="margin-top: 1rem; margin-bottom: 2rem; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
  <iframe 
    
    src="http://localhost:8888/mercury/select-basic?no-navbar"
...
{/* src="https://demo.ismvp.org/mercury/select-basic?no-navbar"  */}