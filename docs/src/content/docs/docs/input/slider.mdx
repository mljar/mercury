...
<Code code={`from mercury import Slider`} lang="python" />
...
<MercuryDemo
iframeSrc="https://demo.ismvp.org/mercury/slider-basic?no-navbar"
notebookUrl="https://demo.ismvp.org/mercury/slider-basic"
/>
