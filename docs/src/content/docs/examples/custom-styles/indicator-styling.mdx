...
import indicatorExamplesDefault from "../../../../assets/examples/custom-styles/indicator/indicator-examples-default.webp";
import indicatorExamplesVariant from "../../../../assets/examples/custom-styles/indicator/indicator-examples-variant.webp";
import indicatorExamplesCustom from "../../../../assets/examples/custom-styles/indicator/indicator-examples-custom.webp";
