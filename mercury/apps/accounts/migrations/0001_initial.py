# Generated by Django 3.2.5 on 2023-02-23 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('share', models.CharField(blank=True, choices=[('PUBLIC', 'Anyone can access notebooks and execute'), ('PRIVATE', 'Only selected users have access to notebooks')], default='PUBLIC', max_length=32, null=True)),
