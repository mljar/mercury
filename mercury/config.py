...
CSS_VARIABLE_MAP = {
    ...
    "panel_bg_hover": "--mercury-panel-bg-hover",
    "panel_bg_hover_2": "--mercury-panel-bg-hover-2",
    "widget_background_color": "--mercury-widget-background-color",
    "card_background_color": "--mercury-card-background-color",
    "border_color": "--mercury-border-color",
    "border_radius": "--mercury-border-radius",
    "border_radius_sm": "--mercury-border-radius-sm",
    "border_radius_lg": "--mercury-border-radius-lg",
    ...
    "button_primary_text": "--mercury-button-primary-text",
    "button_shadow": "--mercury-button-shadow",
    "button_shadow_hover": "--mercury-button-shadow-hover",
    "danger_color": "--mercury-danger-color",
    "success_color": "--mercury-success-color",
    "warning_color": "--mercury-warning-color",
    "slider_track_color": "--mercury-slider-track-color",
